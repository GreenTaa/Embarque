...
#info is a dictionnary that gets the qr data after getting decoded
    ...
    collector = {"id_collector": info['id']  , "id_poubelle" : "615317ecb94fd7811415cd52"}                        #data from QR  code IF role collector
...
#we have number of bottles and supporter id and a static trash bin id 
        print(nb_bottles)
        supporter = {"id_supporter": info['id'] , "Bottles" : nb_bottles ,  "id_poubelle" : "615317ecb94fd7811415cd52"}  #data from QR  code IF role supporter
